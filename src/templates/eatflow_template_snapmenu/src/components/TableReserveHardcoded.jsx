...
const TableReserveHardcoded = () => {
  ...
  const reservationDetails = {
    date: '2025-03-20T00:00:00.000Z', // Example date
    time: '7:00 PM', // Example time
    guests: 4, // Example guests
    tableNumber: '12', // Example table number
    name: 'John Doe', // Example name
    email: 'john.doe@example.com', // Example email
    phone: '123-456-7890', // Example phone
    specialRequests: 'Window seat preferred' // Example special requests
  };
          ...
          <div className="bg-white rounded-lg p-8 md:p-12 shadow-xl border border-gray-200">
            <div className="text-center mb-8">
              ...
              <div className="mt-4 bg-green-50 text-green-700 py-2 px-4 rounded-lg inline-block">
                Confirmation Code: <span className="font-bold">HARDCODED-CODE</span>
              </div>
            </div>
...
export default TableReserveHardcoded;
