...
export function About() {
  ...
  // Use story data from siteContent with fallback to default
  const storyContent = siteContent?.story || defaultStory;
  const brandContent = siteContent?.brand || defaultBrand;
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              These core principles guide everything we do at {brandContent.name}
            </p>
          </div>
