...
export function ReservationForm({ defaultDate, defaultTime, defaultPartySize, onComplete }) {
  const { makeReservation,loading, error: contextError, config } = useReservation();
  ...
  }, [formData.date, formData.partySize, lastFetchTime]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const reservationData = {
        ...
        restaurant_id: sessionStorage.getItem("restaurant_id") || "default_restaurant_id"
      };
        ...
        <div className="grid gap-6">
          ...
          <div>
            ...
            >
              ...
              {["11:00 AM", "11:30 AM", "12:00 PM", "12:30 PM", "1:00 PM", "1:30 PM", "5:00 PM", "5:30 PM", "6:00 PM", "6:30 PM", "7:00 PM", "7:30 PM", "8:00 PM", "8:30 PM"].map((t) => (
