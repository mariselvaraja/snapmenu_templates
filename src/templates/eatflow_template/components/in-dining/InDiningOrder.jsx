        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex-shrink-0 flex items-center">
              <UtensilsCrossed className="h-6 w-6 text-green-500 mr-2" />
              <div>
                <h1 className="text-xl font-bold text-white">EatFlow</h1>
                ...
                <div className="flex items-center justify-center h-[50vh]">
                  <div className="text-center max-w-md">
                    <div className="w-24 h-24 bg-green-50 rounded-full flex items-center justify-center mx-auto mb-6">
                      <UtensilsCrossed className="h-12 w-12 text-green-400" />
                    </div>
                    ...
                    <button
                      ...
                      className="px-8 py-3 bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors flex items-center mx-auto"
                    >
                      View All Menu Items
                    </button>
                  </div>
                ...
                >
                  ...
                  <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <h3 
                        className="text-lg sm:text-xl font-semibold cursor-pointer hover:text-green-500"
                        onClick={() => handleProductClick(item)}
                      >
                        {item.name}
                      </h3>
                    ...
                    <div className="flex justify-between items-center mt-auto">
                      ...
                      <button 
                        ...
                        className="flex items-center gap-2 bg-green-500 text-white px-4 sm:px-6 py-2 rounded-full hover:bg-green-600 transition-colors text-sm sm:text-base"
                      >
                        Add <Plus/>
                      </button>
                    </div>
