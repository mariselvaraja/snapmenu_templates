...
export function WaitlistForm({ date, time, partySize, onClose }) {
  const navigate = useNavigate();
  const { loading, error, config } = useReservation();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/reserve/confirmation?waitlist=true');
    } catch (err) {
    ...
    <div className="p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="text-sm text-gray-500 space-y-2">
          <p>• We'll notify you when a table becomes available</p>
