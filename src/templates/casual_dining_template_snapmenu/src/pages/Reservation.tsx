        ...
        <div className="relative z-10 container mx-auto px-6 h-[calc(50vh-120px)] flex items-center justify-center text-center">
          <div>
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 animate-fade-in">
              {reservationContent.header.title}
            </h1>
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <form className="space-y-8" onSubmit={handleSubmit}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-gray-300 font-medium mb-2">{reservationContent.form.labels.name}</label>
                      <input
                        type="text"
                        value={name}
                    ...
                    <div>
                      <label className="block text-gray-300 font-medium mb-2">{reservationContent.form.labels.email}</label>
                      <input
                        type="email"
                        value={email}
                    ...
                    <div>
                      <label className="block text-gray-300 font-medium mb-2">{reservationContent.form.labels.phone}</label>
                      <input
                        type="tel"
                        value={phone}
                ...
                {/* Special Requests */}
                <div>
                  <label className="block text-gray-300 font-medium mb-2">{reservationContent.form.labels.specialRequests}</label>
                  <textarea
            ...
            <div className="mt-16 grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center bg-zinc-800 p-6 rounded-xl">
                ...
                <p className="text-gray-300">
                  Phone: {reservationContent.info.contact.phone}<br />
                  <span className="text-sm">{reservationContent.info.note}</span>
                </p>
              </div>
            </div>
          </div>
