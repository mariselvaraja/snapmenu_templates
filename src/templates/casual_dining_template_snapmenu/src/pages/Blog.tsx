...
export const Blog = () => {
  ...
  const blogPosts: BlogPost[] = blogData.posts && blogData.posts.length > 0
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl font-bold mb-4">{blogData.header.title}</h1>
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            {categories.map((category) => (
              <button
                key={category}
                className="px-6 py-2 rounded-full bg-zinc-800 hover:bg-zinc-700 transition-colors"
              >
                {category}
              </button>
            ))}
